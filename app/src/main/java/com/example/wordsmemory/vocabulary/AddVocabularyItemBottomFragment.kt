 ...
 * <pre>
 *    AddVocabularyItemBottomFragment.newInstance(30).show(supportFragmentManager, "dialog")
 * </pre>
 */
class AddVocabularyItemBottomFragment : BottomSheetDialogFragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(
            R.layout.fragment_add_vocabulary_item_bottom_list_dialog,
            container,
            false
        )
    }
    ...
    private inner class ViewHolder internal constructor(
        ...
        inflater.inflate(
            R.layout.fragment_add_vocabulary_item_bottom_list_dialog_item,
            parent,
            false
        )
    ) {
    ...
    companion object {
        ...
        fun newInstance(itemCount: Int): AddVocabularyItemBottomFragment =
