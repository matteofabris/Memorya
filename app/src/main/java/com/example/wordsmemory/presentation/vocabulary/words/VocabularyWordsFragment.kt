...
import com.example.wordsmemory.presentation.vocabulary.VocabularyFragment
import com.example.wordsmemory.presentation.vocabulary.VocabularyFragmentDirections
import com.example.wordsmemory.presentation.vocabulary.category.CategoryFragmentDirections
...
class VocabularyWordsFragment(private val _categoryId: Int = -1) : Fragment() {
    ...
    private fun setupVocabularyList() {
        ...
        vocabularyAdapter.addHeaderAndSubmitList(_viewModel.vocabularyListEntity.value)

        setListDivider()
        setSwipeGesture()

        _viewModel.vocabularyListEntity.observe(
            viewLifecycleOwner,
